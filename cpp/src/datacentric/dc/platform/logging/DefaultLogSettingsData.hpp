...
namespace dc
{
    ...
    class DC_CLASS DefaultLogSettingsDataImpl : public LogSettingsDataImpl
    {
    public: // PROPERTIES

        /// <summary>Verbosity level of log output to the console.</summary>
        LogVerbosity ConsoleVerbosity;

        /// <summary>Verbosity level of log messages.</summary>
